...
def fun():
    ...
    def result_for_query6():
        ...
        sqlDF6 = spark.sql("SELECT Stock_name, avg(Open) as Mean_value from table group by Stock_name ").toPandas()

        pd_output = sqlDF6.to_dict('records')
